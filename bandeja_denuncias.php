...
//LISTO  LAS 50 ULTIMAS DENUNCIAS "INGRESADAS" 
$denuncias_modif=mysqli_query($link,"SELECT a.ID, a.ACC_Nombre, b.Nombre as NomInst, a.DA_Fecha, a.ACC_Telefono, u.Nombre FROM denuncias a, instituciones b, usuarios u WHERE a.vigenTe='1' AND a.DE_IDInstitucion = b.ID AND a.AudUsrAlta=u.Usuario ORDER BY a.AudFecAlta DESC LIMIT 50");
?>
...
<div class="small-12 large-12 columns">
  ...
  <div class="small-12 large-8 columns ">
   <div class="small-12 large-12 columns  menutitulo"> 
	<img src="images/map.png" width="30" height="36" border="0"> <b>&Uacute;ltimas 50 DENUNCIAS</b>
	</div>
...
<div>
  <table border="0" cellspacing="0" cellpadding="0"  style="width:100%">
    ...
    <tr>
      ...
      <td align="center" ><?php echo $row["DA_Fecha"]?> </td>
      <td align="center" ><?php echo $row["Nombre"]?> </td>
      <td align="center" ><a href="#"><img src="images/icon_edit.gif" border="0"  width="20px" height="16px" alt="editar" onClick="window.open('denuncias.php?id_den=<?php echo $row["ID"]?>','_self');" /></a> </td>
    </tr>
    <?php } ?>
  </table>
</div>
