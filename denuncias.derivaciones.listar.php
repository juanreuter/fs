...
{
header("location:denuncias.derivaciones.buscar.php");
}
...
<div class="small-12 large-12 columns">
  ...
  <div class="small-12 large-8 columns ">
	...
	<img src="images/map.png" width="30" height="36" border="0"> <b>Derivaciones Médicas para la <a href="denuncias.php?id_den=<?php echo $_REQUEST["id_denuncia"]?>">Denuncia N° <?php echo $_REQUEST["id_denuncia"] ?></a></b>
	</div>
...
<?php } ?>
            ...
            <tr>
              ...
              <td align="center" <?php echo $bg ?> > <a href="#"><img src="images/icon_edit.gif" border="0"  width="20" height="16" alt="editar" onClick="window.open('denuncias.derivaciones.php?id=<?php echo $row["ID"]?>&id_denuncia=<?php echo $id_denuncia?>','_self');" /></a> </td>
