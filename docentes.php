...
if($_POST["action"] == "G" && $id=="")
{
	...
	if($institucion!="" && $nombre!="")
	{
		 mysqli_query($link,"INSERT INTO personal (IDInstitucion, Nombre, TipoDoc, Documento, CUIL, Cargo, Legajo, FechaNacimiento, Sexo, Direccion, Barrio, IDProvincia, Localidad, CodigoPostal, Telefono, FechaIngreso, Remuneracion, Tareas, UsaLicencia, TareasPasivas, AudUsrAlta, AudFecAlta, vigente,horario_trabajo,correo)
										VALUES ($institucion, '$nombre', $tipo_doc, '$documento', '$cuil', '$cargo', '$legajo', '$fecha_nac', '$sexo', '$direccion', '$barrio', $provincia, '$localidad', '$cp', '$telefono', '$fecha_i', '$remuneracion', '$tareas_a', '$usa_licencia', '$tareas_p', '$usralta', '$fecalta', '1',0,0)");
...
<div class="small-12 large-12 columns">
  ...
  <div class="small-12 large-8 columns ">
	...
	<img src="images/map.png" width="30" height="36" border="0"> <b>Docentes y No Docentes - Alta y Modificaci�n</b>
	</div>
       <div class="clear2"> </div>
    <div class="clear2"> </div>
    <div >
